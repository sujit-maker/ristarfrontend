...
const AddressBookPage = () => {
  ...
  try {
    const response = await fetch('http://localhost:8000/addressbook', {
      ...
      body: JSON.stringify({
        status: form.status,
        refId: "", // Assuming this is auto-generated or not required
        businessType: form.type,
        companyName: form.companyName,
        address: "", // Assuming address is not required for this form
        phone: "", // Assuming phone is not required for this form
        email: "", // Assuming email is not required for this form
        website: "", // Assuming website is not required for this form
        creditTerms: "0", // Default value, can be changed
        creditLimit: "0", // Default value, can be changed
        remark: "", // Assuming remark is not required for this form
        countryId: 1, // Assuming a default country ID, can be changed
    ...
    setShowModal(false);
    setForm({ companyName: "", type: "", country: "", port: "", status: "Active" });
  } catch (error) {
